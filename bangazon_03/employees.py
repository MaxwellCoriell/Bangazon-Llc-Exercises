...
class Employees(Department):
	...
	def eat(self, food, companions):
		randomRestaurant = ["Five Guys Burger's and Fries", "Melrose Billiards Parlor", "Bobbie's Dairy Dip"]
		self.restaurant = random.choice(randomRestaurant)
		print(self.restaurant)
		self.food = food
		self.companions = companions
		print("{} ate a {} at {} with {}, {}, and {}".format(self.full_name, self.restaurant, self.companions[0], self.companions[1], self.companions[2]))
