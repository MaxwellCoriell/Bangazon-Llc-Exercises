...
class Sales(Department):
    ...
    def meet(self):
        ...
        Prints a message identifying a meeting location for the Human Resources department
        '''
        print("Call 1-888-867-5309. The pass code to access the conference call is #2808.")
...
class InfoTech(Department):
    ...
    def __init__(self, name, supervisor, employee_count):
        '''
        Initializes the 'InfoTech' class, which builds on the 'Department' class.
        '''
        super().__init__(name, supervisor, employee_count)
    ...
    def meet(self):
        '''
        Prints a message identifying a meeting location for the Information Technology department
        '''
        print("In Case of Meeting, do not dial 911. Instead, call: 0118 999 881 999 119 725 3")